...
import { IInboundCustomerProps } from './IInboundCustomerProps';
import { escape } from '@microsoft/sp-lodash-subset';
import { DatePicker, Dropdown, IconButton, IDropdownOption, IIconProps, Label, PrimaryButton, TextField } from 'office-ui-fabric-react';
import { FilePicker, IFilePickerResult } from '@pnp/spfx-controls-react/lib';
export interface IInboundCustomerState {
AddIndex:boolean;
AddDoc:boolean;
}
export default class InboundCustomer extends React.Component<IInboundCustomerProps,IInboundCustomerState, {}> {
  private addindoc = [];
    ...
    return (
      <div className={ styles.inboundCustomer }>
        ...
        <div style={{display:"flex",margin:"7px"}}> 
          ...
          />
          <TextField label="Company Doc No" style={{ width: '300px' }}></TextField>
          </div>
          <div style={{display:"flex",margin:"7px"}}> 
          ...
          <table style={{ border: '1px solid #ddd', width: '685px', borderCollapse: 'collapse',marginLeft:"6px" }} hidden ={this.state.AddIndex}>
            <tr>
              ...
              <th style={{ border: '1px solid #ddd', padding: '8px', borderCollapse: 'collapse' }}>Company Doc No</th>
